...
export default function ApprovalPOPage() {
  ...
  useEffect(() => {
    fetchApprovedPOs()
    const handleFocus = () => fetchApprovedPOs()
    const handlePOsApproved = () => fetchApprovedPOs()
    window.addEventListener("focus", handleFocus)
    window.addEventListener("pos-approved", handlePOsApproved)
    return () => {
      window.removeEventListener("focus", handleFocus)
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <div className="flex justify-between items-start gap-2">
        <div>
          <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-foreground tracking-wider">APPROVAL PO</h1>
          <p className="text-xs sm:text-sm text-muted-foreground">Approved purchase orders</p>
        </div>
        <Button
          onClick={fetchApprovedPOs}
          disabled={isLoading}
        ...
        <div className="lg:col-span-1 space-y-4">
          <Card className="bg-card border-border">
            ...
            <CardContent className="p-3 sm:p-4 md:p-6 pt-0">
              <p className="text-xs sm:text-sm text-foreground font-mono">{totalCount} approved orders</p>
          ...
          {isLoading ? (
            <Card className="bg-card border-border">
              <CardContent className="p-6 sm:p-8 text-center">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground">Loading approved purchase orders...</p>
              </CardContent>
            </Card>
          ) : approvedPOs.length === 0 ? (
            <Card className="bg-card border-border">
              <CardContent className="p-6 sm:p-8 text-center">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground">No approved purchase orders found</p>
